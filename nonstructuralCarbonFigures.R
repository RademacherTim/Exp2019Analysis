...
for (t in c (1, 5)) {
  ...
  plot (x = summaryDataPhloem [['DateOfSampleCollection']] [con],
        ...
        typ = 'l', xlab = 'date', ylab = 'sugar concentration (% dry weight)', las = 1,
        xlim = c (as_datetime ('2019-04-15'), as_datetime ('2019-10-01')),
        ylim = c (0, 5.5), col = 'white')
...
for (t in c (1, 5)) {
  ...
  plot (x = summaryDataPhloem [['DateOfSampleCollection']] [con],
        ...
        typ = 'l', xlab = 'date', ylab = 'starch concentration (% dry weight)', las = 1,
        xlim = c (as_datetime ('2019-04-15'), as_datetime ('2019-10-01')),
        ylim = c (0, 3), col = 'white')
...
# plot the 2019 root sugar concentration data by tree # TR I need to average for each date or throw out earlier runs
#----------------------------------------------------------------------------------------
layout (matrix (1:8, nrow = 2, byrow = TRUE))
for (t in c (1,3,5,8,2,4,6,7)) {
  # plot below treatment
